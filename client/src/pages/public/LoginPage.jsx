  ...
  return (
    <div className="mx-auto max-w-md">
      <Card className="p-6 sm:p-8">
        <h1 className="mb-1 text-3xl">Welcome Back</h1>
        <p className="mb-6 text-sm text-zinc-400">Login to access your storage workspace.</p>
        ...
        <p className="mt-6 text-center text-sm text-zinc-400">
          New here? <Link to="/signup" className="text-sky-300">Create account</Link>
        </p>
      </Card>
    </div>
  );
