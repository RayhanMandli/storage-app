            ...
            <div className="w-full max-w-md bg-gray-800/30 backdrop-blur-sm border border-gray-700 rounded-2xl p-8 space-y-6">
                ...
                <div className="space-y-3">
                    ...
                    <a
                        ...
                        href={`https://github.com/login/oauth/authorize?client_id=Ov23li5iOPKgLejYkQuQ&scope=read:user user:email&redirect_uri=${import.meta.VITE_BACKEND_URL}/auth/github/callback`}
                    >
